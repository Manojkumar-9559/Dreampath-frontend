...
const CareerGuidanceAfterITI = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Filter categories related to ITI
      const itiCategories = response.data.categories.filter(
        (category) => category.education_id === 4// Assuming ITI has id=3
      );

      setCategories(itiCategories);
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.header}>🎯 Career Guidance After ITI</h2>
      <p style={styles.subHeader}>Select a category to explore career opportunities.</p>
...
export default CareerGuidanceAfterITI;
