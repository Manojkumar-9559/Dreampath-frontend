...
const CareerGuidanceAfterDiploma = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const afterDiplomaCategories = response.data.categories.filter(
        (category) => category.education_id === 3 // Assuming "After Diploma" has id=3
      );

      setCategories(afterDiplomaCategories);
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.header}>🎯 Career Guidance After Diploma</h2>
...
export default CareerGuidanceAfterDiploma;
